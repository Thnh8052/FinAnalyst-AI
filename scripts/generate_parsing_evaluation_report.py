...
Usage:
    python scripts/generate_parsing_evaluation_report.py outputs/test/parsing_review
"""
...
if __name__ == "__main__":
    ...
    from finanalyst.paths import OUTPUT_TEST

    target = Path(sys.argv[1]) if len(sys.argv) > 1 else OUTPUT_TEST / "parsing_review"
